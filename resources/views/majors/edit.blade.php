    ...
    <div class="grid grid-cols-3">
        <form action="{{ route('majors.update', $major->id) }}" method="POST"
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="code" name="code"
                        class="px-3 py-2 border border-zinc-300 bg-slate-50" placeholder="e.g., IF001"
            ...
            <div class="flex flex-col gap-2">
                ...
                <textarea id="description" name="description" class="px-3 py-2 border border-zinc-300 bg-slate-50"
                    placeholder="Describe this major...">{{ old('description', $major->description ?? '') }}</textarea>
                @error('description')
                    <div class="text-red-500">{{ $message }}</div>
                @enderror
            </div>
