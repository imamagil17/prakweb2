        ...
        <table class="w-full mt-4 bg-white shadow">
            <thead>
                <tr class="border-b border-zinc-200 text-sm leading-normal">
                    ...
                    <th class="p-3 px-6 text-left">Name</th>
                    <th class="p-3 px-6 text-center">Student ID Numbers</th>
                    <th class="p-3 px-6 text-center">Gender</th>
                    <th class="p-3 px-6 text-center">Majors</th>
                    <th class="p-3 px-6 text-center">Status</th>
                    <th class="p-3 px-6 text-center">Actions</th>
                </tr>
            </thead>
